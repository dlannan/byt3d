...
function cairo_ui:Init(width, height)
	...
	if(self.img_arrowup == nil) then 
		self.img_arrowup = self:LoadImage("arrowup", "byt3d/data/icons/generic_arrowup_64.png") 
	...
	if(self.img_arrowdn == nil) then 
		self.img_arrowdn = self:LoadImage("arrowdn", "byt3d/data/icons/generic_arrowdn_64.png") 
