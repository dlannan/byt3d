...
static Quat Qt_(float x, float y, float z, float w)
{
Quat qq;
...
static Quat Qt_Scale(Quat q, float w)
{
Quat qq;
...
void fMat44_Decompose(fMat44* m, float R[4], float T[3], float K[3])
{
HMatrix A;
AffineParts parts;
Quat p;
...
float ooq = 1.0 / sqrtf(parts.q.x*parts.q.x + parts.q.y*parts.q.y + parts.q.z*parts.q.z + parts.q.w*parts.q.w);
